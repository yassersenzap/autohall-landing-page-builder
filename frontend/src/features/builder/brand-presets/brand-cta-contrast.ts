/** Brand-specific overrides where luminance heuristics are insufficient. */
...
/**
 * Resolves readable text color for primary CTA fill buttons.
 * Opel yellow → dark text; Ford blue / Auto Hall red → white text.
 */
