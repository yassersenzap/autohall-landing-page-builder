...
export const COLLECTION_SCHEMAS: CollectionSchema[] = [
  ...
  },
  {
    ...
    itemFields: [
      { key: 'name', type: 'text', label: 'Nom', placeholder: 'Modèle', maxLength: 120 },
      { key: 'energy', type: 'text', label: 'Motorisation', placeholder: 'Thermique / Hybride…', maxLength: 64 },
      { key: 'tag', type: 'text', label: 'Badge', placeholder: 'Optionnel', maxLength: 48 },
      {
        key: 'media',
        type: 'asset',
        label: 'Visuel',
      ...
      { key: 'ctaText', type: 'text', label: 'Libellé CTA', placeholder: 'Découvrir', maxLength: 64 },
  ...
  },
  {
    ...
    itemFields: [
      ...
      { key: 'buttonText', type: 'text', label: 'Bouton', placeholder: 'Choisir', maxLength: 64 },
      { key: 'buttonHref', type: 'url', label: 'Lien bouton', placeholder: '#lead-form' },
  ...
  },
  {
    ...
    emptyState: 'Ajoutez des questions fréquentes et leurs réponses.',
    itemFields: [
      { key: 'question', type: 'text', label: 'Question', placeholder: 'Question client', maxLength: 240 },
      { key: 'answer', type: 'textarea', label: 'Réponse', placeholder: 'Réponse détaillée', maxLength: 2000 },
    ],
  },
  {
    blockType: 'benefits',
    ...
    emptyState: 'Ajoutez les points forts ou services.',
    itemFields: [
      { key: 'title', type: 'text', label: 'Titre', placeholder: 'Titre court', maxLength: 120 },
      { key: 'description', type: 'textarea', label: 'Description', placeholder: 'Détail', maxLength: 500 },
    ],
  },
  {
    ...
    minItems: 1,
    maxItems: 9,
    addItemLabel: 'Ajouter une caractéristique',
    emptyState: 'Ajoutez les points techniques du véhicule.',
    itemFields: [
      { key: 'title', type: 'text', label: 'Titre', placeholder: 'ex. Motorisation hybride', maxLength: 120 },
      { key: 'description', type: 'textarea', label: 'Description', placeholder: 'Détail', maxLength: 500 },
    ],
  },
  {
    ...
    minItems: 0,
    maxItems: 6,
    addItemLabel: 'Ajouter un point fort',
    emptyState: 'Ajoutez les atouts de l’offre.',
    itemFields: [
      { key: 'title', type: 'text', label: 'Titre', placeholder: 'ex. Garantie', maxLength: 120 },
      { key: 'description', type: 'textarea', label: 'Description', placeholder: 'Détail', maxLength: 500 },
    ],
  },
  {
    ...
    maxItems: 9,
    addItemLabel: 'Ajouter un témoignage',
    emptyState: 'Ajoutez des avis clients.',
    itemFields: [
      { key: 'quote', type: 'textarea', label: 'Citation', placeholder: 'Témoignage', maxLength: 800 },
      { key: 'author', type: 'text', label: 'Auteur', placeholder: 'Prénom N.', maxLength: 80 },
      { key: 'role', type: 'text', label: 'Ville / rôle', placeholder: 'Optionnel', maxLength: 80 },
    ],
  },
  {
    blockType: 'trust_bar',
    ...
    maxItems: 4,
    addItemLabel: 'Ajouter un indicateur',
    emptyState: 'Ajoutez des chiffres de réassurance.',
    itemFields: [
      { key: 'value', type: 'text', label: 'Valeur', placeholder: 'ex. 50+', maxLength: 32 },
      { key: 'label', type: 'text', label: 'Libellé', placeholder: 'ex. Concessions', maxLength: 80 },
    ],
  },
];
