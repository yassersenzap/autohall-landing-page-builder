...
export type NormalizedSectionStyle = Required<
  Omit<SectionStyleProps, 'customBackgroundColor'>
> & {
  customBackgroundColor: string;
};

export type SectionStyleCapabilities = {
  sectionPaddingY: boolean;
  sectionPaddingX: boolean;
  containerWidth: boolean;
  sectionBackground: boolean;
  verticalDensity: boolean;
