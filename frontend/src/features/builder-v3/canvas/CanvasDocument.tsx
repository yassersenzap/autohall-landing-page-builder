...
import { CanvasBlockInsertSlot } from './CanvasBlockInsertSlot';
          ...
          {sorted.length === 0 ? (
            ...
            >
              <SortableContext items={blockIds} strategy={verticalListSortingStrategy}>
                <CanvasBlockInsertSlot insertIndex={0} />
                {sorted.map((block, index) => (
                  <div key={block.id}>
                    ...
                    <CanvasBlockInsertSlot insertIndex={index + 1} />
                  </div>
                ))}
              </SortableContext>
            </DndContext>
